...
use frontend\models\Taskassignments;
...
/**
 * TaskassignmentController implements the CRUD actions for Taskassignment model.
 */
class TaskassignmentController extends Controller
{
    ...
    {
        $searchModel = new Taskassignments();
        $dataProvider = $searchModel->searchAssigned($this->request->queryParams);
